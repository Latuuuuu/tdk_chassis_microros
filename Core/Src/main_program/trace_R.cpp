...
using intersection = struct intersection1;
static intersection inter_1 = { -83.0, 616.0, -43.0, -120.0 }; //cm
static intersection inter_2 = { 0.0, 616.0, 40.0, -40.0 }; //cm
static intersection inter_3 = { 81.0, 616.0, 116.0, 41.0 }; //cm
static intersection inter_4 = { 151.0, 616.0, 191.0, 116.0 }; //cm
static intersection inter_5 = { 267.0, 616.0, 307.0, 227.0 }; //cm
static intersection inter_6 = { 487.0, 335.0, 537.0, 437.0 }; //cm
